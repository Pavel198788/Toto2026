...
const FLAGS: Record<string, string> = {
  ...
  "United States": iso("US"), "USA": iso("US"), "Mexico": iso("MX"), "Canada": iso("CA"),
  ...
  "Switzerland": iso("CH"), "Austria": iso("AT"), "Turkey": iso("TR"), "Türkiye": iso("TR"),
  ...
  "North Macedonia": iso("MK"), "Bosnia and Herzegovina": iso("BA"), "Bosnia-Herzegovina": iso("BA"), "Bosnia & Herzegovina": iso("BA"),
  // Африка
